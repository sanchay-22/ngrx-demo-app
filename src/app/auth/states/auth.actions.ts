...
export const setLoginSucceedAction = createAction(`${AUTH_KEY_CONST}login succeed`, props<{ user: UserModel, redirectToHome: boolean }>());
...
export const setSignUpSucceedAction = createAction(`${AUTH_KEY_CONST} signup succeed`, props<{ user: UserModel ,redirectToHome: boolean }>());
